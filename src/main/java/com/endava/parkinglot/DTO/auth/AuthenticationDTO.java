...
public class AuthenticationDTO {
    ...
    @Pattern(regexp = "^(?=.{5,320}$)[a-z0-9!#$%&'*+/=?^_`{|}~-]{1,64}@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$", message="Invalid email. It should be like: 'example@email.com'.", groups = PatternValidationGroup.class)
